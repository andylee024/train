...
// File is at app/cli/commands/plan.ts → repo root is 3 levels up.
// V0 hardcodes the single athlete; multi-athlete will derive from TRAIN_USER_ID.
const REPO_ROOT = path.join(__dirname, "..", "..", "..");
const ATHLETE_DIR = path.join(REPO_ROOT, "athletes", "andy");
const WEEKLY_PLANS_DIR = path.join(ATHLETE_DIR, "weeks");
