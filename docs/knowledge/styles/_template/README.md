...
2. Open `<your-style-slug>/exercise-selection.md` and replace the example rows with the subset of `knowledge/exercises.md` that's relevant to this style.
