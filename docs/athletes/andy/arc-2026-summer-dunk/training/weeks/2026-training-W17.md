...
- Primary Focus: Dissipate fatigue so the W18 tests land fresh. Same split shape, volume cut ~half — squat/upper waves drop to 2 light sets, coach Oly runs light or yields. BJJ 1 light night max. Fri + Sat optional (keep short).
...
Same skeleton, everything at half volume. **Priority = arriving fresh for W18 tests**, not adding work.
...
Full rest, or a light movement primer. Protect W18 freshness.
...
Adjustment: W18 = TEST WEEK — bench (Mon), clean+jerk (Thu), pull-up (Fri), DUNK (Sat).
