...
2. **BJJ tapers to 1–2 LIGHT technique nights/week** — no hard rolling (protect CNS freshness for the jump). W11–14: Mon + optional Tue/Wed light. W15: 1 light night max (or rest). W16: rest. **No BJJ Fri/Sat** (Fri is now full rest).
...
4. **Squat removed / Sunday becomes light active recovery.** In B2 Sunday was moderate-heavy; in B3 peak logic strips lower volume. No straight heavy squats anywhere — they'd compromise Sat. Speed squat (Thu) is the only barbell squat pattern and it tapers W15–16.
5. **Nutrition → maintenance from W11.** No cut during peak (VJ §9 — aggressive deficits compromise force).
6. Bench Mon (G5): W11 3×3@200 · W12 3×3@205 · W13 3×2@215 · W14 3×2@220 · W15 3×1@235 (90%) · W16 TEST 1RM (260).
7. Pull-Up **Mon** (G5, folded onto the Upper day from the retired Fri vertical day): RESET target to +55–60×5 (the +80×8 target was unrealistic from a +25×5 baseline). Wave: W11 +45 · W12 +50 · W13 +52 · W14 +55 · W15 +57 doubles (taper) · W16 TEST +55–60×5 **(test-week exception: the pull-up test sits on Fri for spacing)**. Strict/landmine press held at maintenance.
8. Power Clean + Jerk Thu (G2): shoulder healed 2026-06-14 — jerk reintroduced, ramp load 2–3 wks before max. Clean: W11 4×2@160 · W12 @165 · W13 @170 · W14 @~210–215 (heavy double toward test) · W15 taper · W16 TEST full power clean 225. Jerk: build doubles W11 @185 → W14 @205–215 · W15 taper · W16 TEST jerk 225. **Both filmed top single at W16.** Revert to landmine/hang if shoulder or wrist pain ≥3 returns.
9. Speed Squat Thu: 260→280 wave, taper W15–16. Jump Squat 3×3 @ 30%. RDL light 3×5, tapering.
10. Hang/Power Snatch Tue (variety): 125→140 wave, taper. Continuous Broad Jumps 3×3 max dist (replaces single-leg bounds in B3).
11. Depth Jump Sat: W11–12 mid box 3×3 · W13–14 high box 2×3 · W15 low taper 2×5 · W16 NONE (just approach jumps before the dunk test, full freshness).
12. Dunk attempts Sat: 10+ max-intent attempts EVERY Saturday. Film all. Adjust approach mechanics weekly per VJ §8. **W16 = the dunk test.**
13. Sprints: Sat 3×20yd (jump day, primary); Tue 3×20yd + 1×40yd. Chase sprint PRs W13–14 then taper.
14. Upper accessories drop to maintenance (2–3 sets). Recovery budget goes to the tests.
15. INTENSITY CURVE: W11–12 RPE 7–8 (realize). W13–14 RPE 8–9 (peak). W15 TAPER (50% volume, 90% intensity). W16 TEST WEEK.
...
6. Fri: 🛌 **REST** (pre-jump) — no lift, no BJJ. *(Test week W16 is the one exception: the pull-up test gets Fri for max-spacing.)*
7. Sat: JUMP DAY — Max Jump + Dunk Attempts every session (TEST DAY)

> **The per-week tables below preserve the canonical loads.** Their day *homing* follows the new model: pull-up is on **Mon** (not Fri), and **Fri is rest** except in the W16 test week. The week files (`weeks/2026-training-W11…W16.md`) are the authoritative day-by-day layout.

## Week-by-Week Programming

### Week 1 (W11 — realize, RPE 7–8)
...
### Week 5 (W15 — TAPER: 50% volume, 90% intensity)
...
### Week 6 (W16 — TEST WEEK — the payoff)
