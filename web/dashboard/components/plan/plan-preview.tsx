...
export function PlanPreview({
  ...
  return (
    <div className="max-w-5xl mx-auto py-4">
      ...
      {/* Sample week — toggle by block (A24-298); horizontal scroll on mobile, 7-col grid on >=sm */}
      <Section label="Sample week" meta={sampleWeek.label}>
        ...
        />
        <div className="mt-3 -mx-1 px-1 flex gap-1.5 overflow-x-auto snap-x snap-mandatory sm:grid sm:grid-cols-7 sm:overflow-visible sm:snap-none sm:mx-0 sm:px-0">
