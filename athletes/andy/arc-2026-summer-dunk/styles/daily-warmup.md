...
|---|---|---|---|
| 1 | **Cat-Cow** | 2 × 8 each direction | Spine prep, opens shoulders + hips |
| 2 | **World's Greatest Stretch** | 2 × 3 / side | Hip flexor + T-spine + hamstring in one |
| 3 | **Hip CARs** (quadruped) | 2 × 5 each direction / leg | Hip joint capsule — your weak link |
...
**1. Cat-Cow** — On hands and knees. Inhale → drop belly, look up (cow). Exhale → round spine, tuck chin (cat). 8 reps each direction = 16 total. Don't rush.

**2. World's Greatest Stretch** — Lunge forward, opposite hand to inside of front foot. Same-side hand reaches up to ceiling, rotate T-spine to follow it. Hold 2s at top, return. Switch sides. 3 reps/side.

**3. Hip CARs (quadruped)** — On hands and knees. Lift one knee, draw the biggest possible circle with it — out to the side, up toward the ceiling, back behind you, around to start. Slow, controlled, no spine compensation. 5 reps each direction (forward and reverse), then switch leg.

**4. 90/90 + Forward Reach** — Sit with both knees bent at 90° — front leg flat, back leg flat behind. Sit TALL. Reach both hands over the front knee toward the ground. 5 reps, then transition to other side (sweep legs across). Front-leg forward reach is what loads the hip into IR.

**5. Cossack Squat** — Wide stance, feet flat. Shift weight to one leg, drop into a deep side squat — push the working-side knee out, keep both heels down. Other leg stays straight, toes pointed up. Hold 1-2s at bottom, push back up. 5/side. If can't go deep with heels down, work to half-depth first.
...
**Don't progress this for 8 weeks.** The point is habit consolidation, not load progression. Once it's automatic (no thinking, just doing), reassess at Wk 9 whether to add a 3rd set, swap movements, or layer in more advanced work (e.g., FRC-style PAILs/RAILs).

If you find yourself wanting variety before then, that's the signal you haven't built the habit yet — stay the course.
