...
2. Mon Aug 24 (MONDAY): **Upper Horizontal + Side Split Maintenance (taper)**
3. Tue Aug 25 (TUESDAY): Speed-Strength B — Olympic Variety + Sprint PRs
4. Wed Aug 26 (WEDNESDAY): **🛌 REST DAY**
5. Thu Aug 27 (THURSDAY): Speed-Strength A — Olympic Taper + Speed Work
6. Fri Aug 28 (FRIDAY): **Upper Vertical + Side Split Maintenance (taper)**
...
## Mon Aug 24 (MONDAY) — Upper Horizontal + Side Split Maintenance (taper)

### Part A — Maintenance flex (~12 min)

1. **[FLEX]** Taylor's Pose PIR: 2×5 reps × (5s+5s)
2. **[FLEX]** Bent-Knee Pancake: 2×5 × 3s hold
3. **[FLEX]** Supported Side Split: 2×5 × 3s hold

### Part B — Upper Horizontal (~30 min)

4. **[ARC]** Bench Press: wave to test @ 3×1 @ 235 (90%)
5. **[ARC]** Barbell Row: 3×5 @ 195
6. **[ARC]** DB Incline Bench (neutral): 3×5 @ 65
...
## Wed Aug 26 (WEDNESDAY) — 🛌 REST DAY

Full rest. Arc final 2 weeks — taper phase.
...
## Fri Aug 28 (FRIDAY) — Upper Vertical + Side Split Maintenance (taper)
...
4. **[ARC]** Weighted Pull-Up: wave to test @ 3×2 @ +75
5. **[ARC]** Weighted Dips: 3×5 @ +35
