...
Cross-reference: the master library at `docs/content/training-styles/exercises.md`. Flag exercises mentioned in sources but missing from the library.
...
Look for **style-specific demands only** (universal floors live in `docs/content/training-styles/concepts/recovery.md`):
