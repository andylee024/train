...
ACTIVE_DIR = f'{TRAINING_DIR}/active'
OUTPUTS_DIR = f'{BUNDLE_DIR}/outputs'

for d in (BUNDLE_DIR, TRAINING_DIR, BLOCKS_DIR, WEEKS_DIR, ACTIVE_DIR, OUTPUTS_DIR):
...
def render_week_md(arc_week, spec, week_idx):
    ...
    L.append('')
    L.append(f'- Block: training/blocks/{spec["filename"]}')
